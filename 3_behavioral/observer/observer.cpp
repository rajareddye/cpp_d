...
Problem statement: Suppose you are developing a weather monitoring application, 
...
When a weather station collects new data, all registered displays should be updated automatically with the latest 
*/
